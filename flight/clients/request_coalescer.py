...
class RequestCoalescer:
    ...
    Usage:
        coalescer = RequestCoalescer(service_name="flight")

        @coalescer.coalesce
        async def get_flight(flight_iata: str):
            # Appel API réel
            return await api_client.get(f"/flights/{flight_iata}")
    ...
    def __init__(self, service_name: str = "flight"):
        """
    ...
    async def execute(
        ...
        **kwargs
        ...
        Args:
            key: Clé unique pour cette requête (ex: "flights/AF123")
